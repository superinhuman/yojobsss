...
<body class="subpage">
      ...
      <div class="container">
          ...
          <div class="col-md-3">
            <div class="profile-sidebar">
              ...
              <div class="profile-userpic">
                <img src="<?php echo $_SESSION['img'] ?>" class="img-responsive" alt="">
              </div>
              <!-- END SIDEBAR USERPIC -->
              <!-- SIDEBAR USER TITLE -->
              <div class="profile-usertitle">
                ...
                <div class="profile-usertitle-job">
                  <?php echo $_SESSION["organisation"]?>
                </div>
              </div>
          ...
          <div class="col-md-9">
                  <div style=" display: inline-block;" class="profile-content">
                    <table>
                      <tr>
                        <td>Name</td>
                      ...
                      <tr>
                        ...
                        <td> <?php echo $_SESSION["organisation"]; ?></td>
                      </tr>
                  </table>
                  <a href="edit.php" style="background-color: green">Edit</a>
